...
public class AboutCommand extends BotCommand {
    ...
    public void execute(AbsSender absSender, User user, Chat chat, String[] arguments) {
        ...
        about.append("Привет!\nЯ бот для игры в \"Я никогда не\".\n\n")
                ...
                .append("Каждый игрок, подтвердивший утверждение, получает один балл. ")
                .append("Ведущий получит балл, только если найдется хоть один игрок, который опровергнет утверждение.\n\n")
